(function() {
  ...
  const local =
    DEPLOYMENT_CONFIG.ENVIRONMENT_OVERRIDE === "local" ||
  ...
  window.MedOptionsConfig = {
    ...DEPLOYMENT_CONFIG,
    API_BASE_URL: local ? localApi : DEPLOYMENT_CONFIG.REMOTE_API_BASE_URL,
    REQUEST_TIMEOUT_MS: local
      ? DEPLOYMENT_CONFIG.LOCAL_REQUEST_TIMEOUT_MS
      : DEPLOYMENT_CONFIG.REMOTE_REQUEST_TIMEOUT_MS
  };
})();
